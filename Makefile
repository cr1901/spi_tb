...
check: $(PROJECT).smt2
	yosys-smtbmc -s z3 -t 180 --dump-smt2 $(PROJECT)_bmc.smt2 --dump-vcd $(PROJECT)_bmc.vcd $(PROJECT).smt2
	yosys-smtbmc -s z3 -i -t 180 --dump-smt2 $(PROJECT)_tmp.smt2 --dump-vcd $(PROJECT)_tmp.vcd $(PROJECT).smt2
